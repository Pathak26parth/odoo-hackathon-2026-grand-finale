...
router.get('/', requireAuth, requirePermission(PERMISSIONS.CONTRACTS_READ), (req, res, next) => contractController.getContracts(req, res, next));
router.get('/:id', requireAuth, requirePermission(PERMISSIONS.CONTRACTS_READ), (req, res, next) => contractController.getContractById(req, res, next));
